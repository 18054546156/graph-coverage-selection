...
Examples:
  ...
  python -m graphcov.run --analyze all  # analyze all runs together
    ...
    parser.add_argument('--quota-floor-ratio', type=float, default=0.75,
                        help='M1 minimum quota as a fraction of equal quota (default: 0.75)')
    parser.add_argument('--quota-normalization', choices=['mass', 'self_optimum'],
                        default='self_optimum',
                        help='M1 class marginal normalization (default: self_optimum)')
...
def main():
    ...
    config = {
        ...
        'quota_floor_ratio': args.quota_floor_ratio,
        'quota_normalization': args.quota_normalization,
