...
Examples:
  ...
  python -m graphcov.run --analyze all  # analyze all runs together
    ...
    parser.add_argument('--relation-mode',
                        choices=['baseline', 'scalar', 'same_class', 'class_pair'],
                        default='class_pair', help='M2 relation gate mode')
    parser.add_argument('--cross-credit', type=float, default=0.25,
                        help='M2 scalar cross-class credit (default: 0.25)')
    parser.add_argument('--relation-strength', type=float, default=1.0,
                        help='M2 interpolation from all-ones to estimated pair gate')
    parser.add_argument('--pair-min-credit', type=float, default=0.0,
                        help='M2 lower bound for estimated class-pair credit')
    parser.add_argument('--pair-smoothing', type=float, default=1.0,
                        help='M2 prior smoothing mass for class-pair estimation')
...
def main():
    ...
    config = {
        ...
        'cross_credit': args.cross_credit,
        'relation_strength': args.relation_strength,
        'pair_min_credit': args.pair_min_credit,
