...
Examples:
  ...
  python -m graphcov.run --analyze all  # analyze all runs together
    ...
    parser.add_argument('--purity-exponent', type=float, default=1.0,
                        help='M3 purity exponent; 0 exactly disables M3')
    parser.add_argument('--trust-mode', choices=['purity', 'adaptive'], default='purity',
                        help='M3 fixed purity or local-support adaptive exponent')
    parser.add_argument('--trust-weight-floor', type=float, default=0.0,
                        help='M3 minimum client trust weight in [0, 1]')
...
def main():
    ...
    config = {
        ...
        'purity_exponent': args.purity_exponent,
        'trust_mode': args.trust_mode,
        'trust_weight_floor': args.trust_weight_floor,
