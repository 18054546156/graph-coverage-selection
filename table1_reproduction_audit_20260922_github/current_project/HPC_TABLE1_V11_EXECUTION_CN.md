...
HCP root: /project/PROJECT_ROOT/USER/graph_bench
...
```text
/home/HPC_USER_A/.medmnist/{organsmnist,organamnist,pathmnist,tissuemnist,bloodmnist}_224.npz
```
...
ln -s /project/PROJECT_ROOT/USER/graph_select/cache/embeddings cache/embeddings
ln -s /project/PROJECT_ROOT/USER/graph_select/envs/graphcov-py311 envs/graphcov-py311

export GRAPHCOV_PYTHON=/project/PROJECT_ROOT/USER/graph_bench/envs/graphcov-py311/bin/python
```
...
```bash
cd /project/PROJECT_ROOT/USER/graph_bench
...
```bash
V11_CONFIG=/project/PROJECT_ROOT/USER/graph_bench/v11/configs/job2_table1_validation_seed42.json
...
```bash
V11_CONFIG=/project/PROJECT_ROOT/USER/graph_bench/v11/configs/job2_table1_validation_3seeds.json
...
```bash
V11_CONFIG=/project/PROJECT_ROOT/USER/graph_bench/v11/configs/generated_job2_table1_test.json
